  ...
  return (
    <>
      ...
      <main className="min-h-[100svh] min-w-0 overflow-x-clip px-4 pb-[clamp(4rem,9svh,7rem)] pt-[clamp(5.5rem,11svh,7rem)] sm:px-6">
        <Reveal className="theme-order-panel mx-auto w-full min-w-0 max-w-[760px] overflow-hidden rounded-sm border border-[var(--line)] p-[clamp(1.25rem,3.5vw,2.75rem)] text-center shadow-[0_24px_80px_var(--shadow-color)] backdrop-blur-sm">
